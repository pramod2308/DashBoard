var app = angular.module('app').controller('CMSFailedDashBoardCtrl', ['$scope', '$http', 'ServiceCall', '$log', '$window', 'cache', function ($scope, $http, ServiceCall, $log, $window, cache) {
    ...
    function changedValue(item) { 
        ...
        var item = {};
        item.ESBTab = 100;
        item.TransactionName = 'CMSFailed'
        item.Sdattime = STime;
        item.Edattime = ETime;
        $scope.param = item;
        $('#loader').fadeIn();
