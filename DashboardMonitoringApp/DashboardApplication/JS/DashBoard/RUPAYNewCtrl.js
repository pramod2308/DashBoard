var app = angular.module('app').controller('RupayNewCtrl', ['$scope', '$http', 'ServiceCall', '$log', '$window', 'cache', function ($scope, $http, ServiceCall, $log, $window, cache) {
    ...
    $scope.changedValue = function (item) {
        ...
        item.TransactionType = 'RupayPosting';
        $scope.param = item;
        $('#loader').fadeIn();
