var app = angular.module('app').controller('ctrlESBNodeLatency', ['$scope', '$http', 'ServiceCall', '$log', '$window', 'cache', '$timeout', function ($scope, $http, ServiceCall, $log, $window, cache, $timeout) {

    $scope.sortType = 'Total_on_srvprd1esbapp';
