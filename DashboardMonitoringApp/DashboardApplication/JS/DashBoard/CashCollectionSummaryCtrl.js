var app = angular.module('app').controller('CMSSummaryDashBoardCtrl', ['$scope', '$http', 'ServiceCall', '$log', '$window', 'cache', function ($scope, $http, ServiceCall, $log, $window, cache) {
    ...
    function changedValue(item) {
        ...
        var item = {};
        item.ESBTab = 100;
        item.TransactionName = 'CMSSummary'
        item.Sdattime = STime;
        item.Edattime = ETime;
        $scope.param = item;
        $('#loader').fadeIn();
