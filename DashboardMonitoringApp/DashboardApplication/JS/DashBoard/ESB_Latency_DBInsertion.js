var app = angular.module('app').controller('ESB_Latency_DBInsertionDashBoardCtrl', ['$scope', '$http', 'ServiceCall', '$log', '$window', 'cache', '$timeout', function ($scope, $http, ServiceCall, $log, $window, cache, $timeout) {
    ...
    $scope.changedValue = function (item) {     
        ...
        var item = {};
        item.LatencyType = 'DBInsertion';
        item.DateTime = DatTime;
        $scope.param = item;
        $('#loader').fadeIn();
        $scope.URL = "/PBDashboardApp/DashboardAppService.svc/ProcessLatency";
